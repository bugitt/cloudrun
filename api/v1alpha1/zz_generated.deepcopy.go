...
func (in *BuilderSpec) DeepCopyInto(out *BuilderSpec) {
	*out = *in
	in.Context.DeepCopyInto(&out.Context)
	if in.DeployerHooks != nil {
		in, out := &in.DeployerHooks, &out.DeployerHooks
		*out = make([]DeployerHook, len(*in))
		copy(*out, *in)
	}
}
...
func (in *DeploySpec) DeepCopyInto(out *DeploySpec) {
	*out = *in
	if in.FilePair != nil {
		in, out := &in.FilePair, &out.FilePair
		*out = new(FilePair)
		**out = **in
	}
	if in.BaseImage != nil {
